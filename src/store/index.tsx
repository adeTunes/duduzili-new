...
export const popupSelectedFriendToChat = atom([])
export const pageSearch = atom("")
export const chatFriendOptions = atom<"selected friend" | "chat initiated" | "destroy process" | "">("")
export const popupChatFriendOptions = atom<"selected friend" | "chat initiated" | "destroy process" | "">("")
export const socketConnection = atom(false)
export const wsReconnection = atom(false)
export const openChatDrawer = atom(false)
export const chatMedia = atom("")
export const currentChatFriend = atom("")
export const popupCurrentChatFriend = atom("")
export const popupFriend = atom("")
export const popupFriendList = atom("")
export const popupTotalUnread = atom(0)