...
export const ConnectAppleModal = ({ opened, close }) => {
  const form = useForm({
    initialValues: {
        link: ""
    }
  ...
  return (
    ...
    >
      <p style={{
        ...
        Link your apple account. This will prevent future loss of account and
        easy accessibility
      </p>
      <div className="mt-6">
        <TextInput
          label="Account URL"
          placeholder="Enter your apple account link"
          classNames={{
