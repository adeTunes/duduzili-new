...
function PrivacyPolicy() {
  ...
  const paragraph2 = [
    ...
    {
        title: "CONTACT US",
        body: <span>For any questions or concerns regarding your privacy, you may contact us using the following details: <a href="mailto:privacy@duduzili.com" className="text-duduzili-blue">privacy@duduzili.com</a></span>
    },
  ]
  return (
    <div className="flex flex-col overflow-auto h-screen">
      ...
      <div className="flex-1 overflow-auto">
        ...
        >
          ...
          <div className="flex flex-col gap-[30px] flex-1 overflow-auto" id="no-scroll">
            <h3 className="text-[20px] leading-7 font-bold text-[#2a2a2a]">
              Version 1.0
            </h3>
            <div className="flex flex-col gap-[25px]">
              {paragraph.map((item, idx) => (
                <div key={idx} className="flex flex-col gap-[10px]">
                  <h4 className="text-[16px] leading-6 font-semibold">
                    {item.title}
                  </h4>
                  <p className="text-[20px] leading-8">{item.body}</p>
                </div>
              ))}
              <div className="flex flex-col gap-[10px]">
                ...
                <p className="text-[20px] leading-8 flex flex-col gap-[12px]">
                  <span>
                  ...
                  <ol>
                    <li>
                      1. Use a mobile device or web browser to access our content
                    </li>
                    <li>
                      2. Contact us via email, social media, or on any similar technologies
                    </li>
                    <li>
                      3. When you mention us on social media
                    </li>
                  </ol>
                  <span>
                  ...
                  <ol>
                    ...
                    <li>
                      2. For advertising and marketing, including sending you promotional information about our products and services and information about third parties that we consider may be of interest to you
                    </li>
                    <li>
                      3. Please be aware that we may combine information we collect about you with general information or research data we receive from other trusted sources.
                    </li>
                  </ol>
                </p>
              </div>
